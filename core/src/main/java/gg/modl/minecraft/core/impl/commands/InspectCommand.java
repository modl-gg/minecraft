...
public class InspectCommand extends BaseCommand {
    private static final int MAX_NOTES_DISPLAYED = 3;
    private static final int MAX_LINKED_ACCOUNTS_DISPLAYED = 5;
    private static final String STATUS_ACTIVE = "Active";
    private static final String STATUS_PARDONED = "Pardoned";
    private static final String STATUS_INACTIVE = "Inactive";
    private static final String DURATION_PERMANENT = "Permanent";
    private static final String COLOR_YES = "&cYes";
    private static final String COLOR_NO = "&aNo";
    private static final String COLOR_ACTIVE = "&a";
    private static final String COLOR_INACTIVE = "&7";
    private static final String PROFILE_LINK_JSON =
            "{\"text\":\"\",\"extra\":[" +
            "{\"text\":\"  \",\"color\":\"gold\"}," +
    ...
    private void displayPlayerInfo(CommandIssuer sender, PlayerLookupResponse.PlayerData data, LinkedAccountsResponse linkedResponse) {
        ...
        if (!hasNotes) sender.sendMessage(localeManager.getMessage("print.inspect.no_notes"));
