...
This plugin has been worked on extensively and is quite large and uses the following in-house libraries:
...
We welcome any and all contributions and will work with contributors on most PRs within reason (please keep PRs specific and concise, large PRs will be rejected).
