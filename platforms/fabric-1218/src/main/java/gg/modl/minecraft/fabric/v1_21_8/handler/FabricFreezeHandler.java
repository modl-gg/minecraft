...
public class FabricFreezeHandler {
    ...
    public void freeze(String targetUuid, String staffUuid) {
        ...
        if (player != null) {
            frozenAnchors.put(target, new FreezeAnchor((ServerWorld) player.getWorld(),
    ...
    public void onTick() {
        ...
        frozenPlayers.forEach((uuid, staff) -> {
            ...
            if (anchor == null) {
                frozenAnchors.put(uuid, new FreezeAnchor((ServerWorld) player.getWorld(),
                        player.getX(), player.getY(), player.getZ(), player.getYaw(), player.getPitch()));
            ...
            boolean wrongWorld = (ServerWorld) player.getWorld() != anchor.world;
