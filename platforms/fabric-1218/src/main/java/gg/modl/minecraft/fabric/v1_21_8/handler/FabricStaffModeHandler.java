...
public class FabricStaffModeHandler {
    ...
    public void setTarget(String staffUuid, String targetUuid) {
        ...
        if (staffPlayer != null) {
            ...
            if (targetPlayer != null) {
                staffPlayer.teleport((net.minecraft.server.world.ServerWorld) targetPlayer.getWorld(),
    ...
    private void restoreSnapshot(ServerPlayerEntity player) {
        ...
        if (snapshot != null) {
            ...
            player.teleport((net.minecraft.server.world.ServerWorld) player.getWorld(), snapshot.x, snapshot.y, snapshot.z,
    ...
    private void handleRandomTeleport(ServerPlayerEntity player) {
        ...
        player.teleport((net.minecraft.server.world.ServerWorld) target.getWorld(), target.getX(), target.getY(), target.getZ(),
