...
public class NeoForgeBridgePlayer implements BridgePlayer {
    private final ServerPlayer player;

    public NeoForgeBridgePlayer(ServerPlayer player) {
        this.player = player;
    }

    public ServerPlayer getServerPlayer() { return player; }
    ...
    @Override public boolean isOnline() { return !player.hasDisconnected(); }
    ...
    @Override public String getWorldName() { return player.serverLevel().dimension().location().toString(); }
}
